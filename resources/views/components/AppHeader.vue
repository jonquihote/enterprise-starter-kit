...
import { getInitials } from '@/scripts/composables/useInitials'
import type { BreadcrumbItem, NavItem } from '@/types'
import AppLogo from '@/views/components/AppLogo.vue'
import AppLogoIcon from '@/views/components/AppLogoIcon.vue'
...
import { DropdownMenu, DropdownMenuContent, DropdownMenuTrigger } from '@/views/components/ui/dropdown-menu'
import { NavigationMenu, NavigationMenuItem, NavigationMenuList, navigationMenuTriggerStyle } from '@/views/components/ui/navigation-menu'
import { Sheet, SheetContent, SheetHeader, SheetTitle, SheetTrigger } from '@/views/components/ui/sheet'
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@/views/components/ui/tooltip'
import UserMenuContent from '@/views/components/UserMenuContent.vue'
    ...
    <div>
        <div class="border-sidebar-border/80 border-b">
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                ...
                <Link :href="route('base::screens.dashboard')" class="flex items-center gap-x-2">
                    <AppLogo />
                </Link>
